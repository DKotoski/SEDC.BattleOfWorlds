...
using N2.Details;
using N2.Web.Mvc;
using SEDC.BattleOfWorlds.Infrastructure.WebUI.Controllers;
using SEDC.BattleOfWorlds.Infrastructure.WebUI.Models.N2;
using SEDC.BattleOfWorlds.Infrastructure.WebUI.Models;

namespace SEDC.BattleOfWorlds.Infrastructure.WebUI.Registrations
{
    [Registration]
